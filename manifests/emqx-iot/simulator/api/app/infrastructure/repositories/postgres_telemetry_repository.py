...
class PostgresTelemetryRepository:
    ...
    async def load_twin_report_context(self, zone_id: str) -> dict:
        ...
        return {
            ...
            "recentMetrics": [dict(row) for row in reversed(metric_rows)],
        }